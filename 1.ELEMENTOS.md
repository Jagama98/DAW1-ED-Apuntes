...
La CPU se llama tambien UCP (en inglés), procesador o microprocesador.
...
En lenguajes interpretados no existe código objeto ni binario. Sólo código fuente, por ejemplo: PNP, JavaScrip,...
